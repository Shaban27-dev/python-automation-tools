...
A collection of Python automation projects — file management, data processing,
and productivity tools built for real-world use cases.
...
I build Python automation scripts, file tools, data utilities, and CLI
